...
Boc.2016.NFT.1k.121 <- HandL.stepAIC.MCMC(Y.Name = "NumBoc", common_name = "Bocaccio", Area = c('Orig121', 'CCA', 'ALL')[1], Include.FishTime = FALSE, 
...
Boc.2016.NFT.150k.121 <- HandL.stepAIC.MCMC(GLM.FINAL.AIC = Boc.Final.Glm, tune = 0.14, mcmc = 150000, burnin = 1000, thin = 150, verbose = 1000)
...
# Micro to test
Boc.2016.NFT.1k.121 <- HandL.stepAIC.MCMC(Y.Name = "NumBoc", common_name = "Bocaccio", Area = c('Orig121', 'CCA', 'ALL')[1], Include.FishTime = FALSE, Restrict.6min = FALSE, Sites = NULL, 
                             propHookCutOffAggr = ifelse(Area == "ALL", 0.002, 0.003), propHookCutOffMirage = propHookCutOffAggr, propHookCutOffToro = 3 * propHookCutOffAggr,
...
# 150k MCMC   
Boc.2016.NFT.150k.121 <- HandL.stepAIC.MCMC(Y.Name = "NumBoc", common_name = "Bocaccio", Area = c('Orig121', 'CCA', 'ALL')[1], Include.FishTime = FALSE, Restrict.6min = FALSE, Sites = NULL, 
                             propHookCutOffAggr = ifelse(Area == "ALL", 0.002, 0.003), propHookCutOffMirage = propHookCutOffAggr, propHookCutOffToro = 3 * propHookCutOffAggr,
